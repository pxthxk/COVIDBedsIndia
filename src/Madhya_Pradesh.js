        ...
        if(madhya_pradesh_data[i]["LOCATION"] != "") {
          ...
          if(flag == 1) {
            ...
            if((coord[0] != 0) && (coord[1] != 0)) {
              ...
              var loc = "<a href=" + madhya_pradesh_data[i]["LOCATION"].replace(" ", "") + " target='_blank'>View on Google Maps</a><br>";
              var last_updated_at = "Last Updated: " + madhya_pradesh_data[i]["LAST_UPDATED"] + "<br><br>";
              var iso_tot = "<b>ISOLATION BEDS</b><br>Total: " + madhya_pradesh_data[i]["ISOLATION_BEDS_TOTAL"] + "<br>";
              var iso_vac = "Available: " + madhya_pradesh_data[i]["ISOLATION_BEDS_AVAILABLE"] + "<br><br>";
              var oxy_tot = "<b>OXYGEN GENERAL BEDS</b><br>Total: " + madhya_pradesh_data[i]["OXYGEN_BEDS_TOTAL"] + "<br>";
              var oxy_vac = "Available: " + madhya_pradesh_data[i]["OXYGEN_BEDS_AVAILABLE"] + "<br><br>";
              var icu_tot = "<b>ICU BEDS</b><br>Total: " + madhya_pradesh_data[i]["ICU_BEDS_TOTAL"] + "<br>";
