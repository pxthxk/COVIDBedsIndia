class Jharkhand {
  populate(mcg, bedtype) {
    ...
    fetchPromise.then(response => {
      ...
      fetch("https://api.covidbedsindia.in/v1/storages/60b1c92490b4574e2c831017/Jharkhand").then(response => {
        return response.json();
      }).then(location_data => {
        jharkhand_data.map(i => {
          if((i["resource_type"] == "Hospital Beds") && (i["state"] == "JHARKHAND")) {
